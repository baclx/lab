function checkUsername(){                            ////declare function
    ...
    if(username.length < 5){                         //if username < 5 character
...
//when the username input gains /  loser focus call functions above:
el.addEventListener('focus', tipUsername, false); //focus call tipUsername()
el.addEventListener('blue', checkUsername, false); //blur call checkUsername()